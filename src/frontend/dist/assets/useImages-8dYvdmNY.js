...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    ...
    "uploadImage": IDL2.Func([IDL2.Text, ExternalBlob2], [Image2], [])
  });
};
...
function useUploadImage() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      return actor.uploadImage(filename, externalBlob);
    },
    onSuccess: () => {
